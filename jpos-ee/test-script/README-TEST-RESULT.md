...
| 5 | `multi_atm_simulator/prod-iso-atm-stan-tracking.py` | STAN tracking across 0100/0200/0400 lifecycle |
...
## Script 5 — STAN Tracking Simulator (`prod-iso-atm-stan-tracking.py`)

**Command:**
```bash
python3 prod-iso-atm-stan-tracking.py --with-mac
```

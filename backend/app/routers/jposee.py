...
# ============================================================================
# NOTE: Webhook endpoints removed in favor of native jPOS persistence
# ============================================================================
# All ISO message persistence is now handled natively by jPOS-EE via:
# - PersistRequest Participant: Receives and persists ISO transactions
# - UpdateResponse Participant: Updates transaction status and creates audit entries
# - Database: PostgreSQL jposee database (port 5433)
# No webhook callbacks needed - transactions stored directly in database
